...
n_extended_grid = 100 #number of extended grid cells in each direction
minlat = -34.9425
maxlat = -34.8975
minlon = 138.575
maxlon = 138.625
...
pickupList = bin_coords(pickupLat, pickupLon, n, minlat, maxlat, minlon, maxlon, n_extended_grid)
...
dropoffList = bin_coords(dropoffLat, dropoffLon, n, minlat, maxlat, minlon, maxlon, n_extended_grid)
...
dataCell %>%
  drop_na() %>%
  write.csv("../Likelihood Estimation/trips_binned_beam_outofgrid.csv")
```
...
binnedList = bin_coords(lat, lon, n, minlat, maxlat, minlon, maxlon, n_extended_grid)
...
dataCell %>%
  drop_na(cell_num) %>%
  write.csv("../Likelihood Estimation/status_binned_beam_outofgrid.csv")
```
